function criptografa() {
  ...
  btnCryptography.addEventListener("click", function (event) {
    ...
    if (
      textoCriptografado === minusculas &&
      textoCriptografado === semAcento &&
      temCaracterEspecial(textoCriptografado) == false
    ) {
...
function descriptografa() {
  ...
  btnCryptography.addEventListener("click", function (event) {
    ...
    if (
      textoDescriptografado === minusculas &&
      textoDescriptografado === semAcento &&
      temCaracterEspecial(textoDescriptografado) == false
    ) {
